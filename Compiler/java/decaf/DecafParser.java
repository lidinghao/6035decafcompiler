  ...
  astFactory = new ASTFactory(getTokenTypeToASTClassMap());
	...
	public final StringToken  id() throws RecognitionException, TokenStreamException {
		...
		case TK_Program:
		{
			{
			pt = LT(1);
			pt_AST = astFactory.create(pt);
			astFactory.addASTChild(currentAST, pt_AST);
			match(TK_Program);
	...
	public final VarDecl  var_decl() throws RecognitionException, TokenStreamException {
		...
		_loop29:
		do {
			if ((LA(1)==TK_Program||LA(1)==ID) && (LA(2)==COMMA)) {
				i1=id();
				astFactory.addASTChild(currentAST, returnAST);
	...
	public final Location  location() throws RecognitionException, TokenStreamException {
		...
		{
		if ((LA(1)==TK_Program||LA(1)==ID) && (_tokenSet_1.member(LA(2)))) {
			i=id();
			astFactory.addASTChild(currentAST, returnAST);
	...
	public final Statement  statement() throws RecognitionException, TokenStreamException {
		...
		default:
			if ((LA(1)==TK_Program||LA(1)==ID) && (_tokenSet_2.member(LA(2)))) {
				{
				l=location();
				astFactory.addASTChild(currentAST, returnAST);
				a=assign_op();
	...
	public final Expression  expr_static() throws RecognitionException, TokenStreamException {
		...
		default:
			if ((LA(1)==TK_Program||LA(1)==ID) && (_tokenSet_3.member(LA(2)))) {
				e=location();
				astFactory.addASTChild(currentAST, returnAST);
			}
			else if ((LA(1)==TK_callout||LA(1)==TK_Program||LA(1)==ID) && (LA(2)==LPAREN)) {
