...
public DecafScanner(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("if", this), new Integer(5));
	literals.put(new ANTLRHashString("class", this), new Integer(4));
	literals.put(new ANTLRHashString("break", this), new Integer(9));
	literals.put(new ANTLRHashString("callout", this), new Integer(11));
	...
	literals.put(new ANTLRHashString("return", this), new Integer(8));
}
...
tryAgain:
	...
	protected final void mVALIDCHARS(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = VALIDCHARS;
		int _saveIndex;
	...
	public final void mMULDIV(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = MULDIV;
		int _saveIndex;
	...
	public final void mASSIGNPLUSEQ(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = ASSIGNPLUSEQ;
		int _saveIndex;
	...
	public final void mASSIGNMINUSEQ(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = ASSIGNMINUSEQ;
		int _saveIndex;
	...
	public final void mCEQ(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = CEQ;
		int _saveIndex;
